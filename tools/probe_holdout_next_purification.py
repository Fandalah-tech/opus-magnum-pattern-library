...
from packages.opus_solver.purification_chain import search_next_purification_step
...
def probe(
    ...
    *,
    ...
    return {
        "schemaVersion": "0.1.0",
        "kind": "strict-heldout-next-purification-frontier-diagnostics",
        ...
        "baselineValidation": compact_validation(result.get("baselineValidation") or {}),
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Inspect the next blind purification frontier in detail.")
    ...
    parser.add_argument("--variant-limit", type=int, default=480)
