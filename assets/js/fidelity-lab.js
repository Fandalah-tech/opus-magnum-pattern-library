(() => {
  ...
  const atomScene=metal=>({width:84,height:84,board:{visible:false,cols:1,rows:1,size:38,offsetX:42,offsetY:42},atoms:[{element:metal,q:0,r:0}]});
